...
},{"./common":"../../node_modules/engine.io-client/node_modules/debug/src/common.js","process":"../../node_modules/process/browser.js"}],"../../node_modules/engine.io-client/lib/transport.js":[function(require,module,exports) {
...
},{"engine.io-parser":"../../node_modules/engine.io-parser/lib/index.js","component-emitter":"../../node_modules/component-emitter/index.js","debug":"../../node_modules/engine.io-client/node_modules/debug/src/browser.js"}],"../../node_modules/parseqs/index.js":[function(require,module,exports) {
/**
...
},{"socket.io-parser":"../../node_modules/socket.io-parser/dist/index.js","./on":"../../node_modules/socket.io-client/build/on.js","./typed-events":"../../node_modules/socket.io-client/build/typed-events.js","debug":"../../node_modules/socket.io-client/node_modules/debug/src/browser.js"}],"../../node_modules/backo2/index.js":[function(require,module,exports) {
...
},{"engine.io-client":"../../node_modules/engine.io-client/lib/index.js","./socket":"../../node_modules/socket.io-client/build/socket.js","socket.io-parser":"../../node_modules/socket.io-parser/dist/index.js","./on":"../../node_modules/socket.io-client/build/on.js","backo2":"../../node_modules/backo2/index.js","./typed-events":"../../node_modules/socket.io-client/build/typed-events.js","debug":"../../node_modules/socket.io-client/node_modules/debug/src/browser.js"}],"../../node_modules/socket.io-client/build/index.js":[function(require,module,exports) {
"use strict";
...
},{"./url":"../../node_modules/socket.io-client/build/url.js","./manager":"../../node_modules/socket.io-client/build/manager.js","./socket":"../../node_modules/socket.io-client/build/socket.js","debug":"../../node_modules/socket.io-client/node_modules/debug/src/browser.js","socket.io-parser":"../../node_modules/socket.io-parser/dist/index.js"}],"canvasStuff.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mouseListner = exports.draw = void 0;
// This file contains all the data about the canvasObj.canvas
console.log("canvasstuff loaded"); // This function is called for every frame, and if the coordinates of the circle change
// then the circle starts to move

var draw = function draw(globalObj, domElements, canvasObj) {
  ...
  canvasObj.context.setTransform(1, 0, 0, 1, 0, 0); // Clearing the canvasObj.canvas prior to drawing the circle

  canvasObj.context.clearRect(0, 0, canvasObj.canvas.width, canvasObj.canvas.height); // console.log(globalObj.currPlayer);
  // Clamp the camera to this connected player's circle

  var camX = -globalObj.currPlayer.locX + canvasObj.canvas.width / 2;
  var camY = -globalObj.currPlayer.locY + canvasObj.canvas.height / 2; // console.log("cam is" + camX, camY);

  canvasObj.context.translate(camX, camY); // Render all the players with their updated positions

  globalObj.allPlayers.forEach(function (playerEl) {
    // The beginPath() method begins a path, or resets the current path.
    canvasObj.context.beginPath(); // The fillStyle method add color to the path

    canvasObj.context.fillStyle = playerEl.color; // Arc method creates a circle

    canvasObj.context.arc(playerEl.locX, playerEl.locY, playerEl.radius, 0, Math.PI * 2); // canvasObj.context.arc(200, 200, 10, 0, Math.PI * 2);

    canvasObj.context.fill(); // Stroke properties for the path
  ...
  var html = "";
  globalObj.leaderboard.forEach(function (playerEl) {
    html += "\n    <li class=\"leaderboard__player\">\n    <span class=\"leaderboard__player__name\">".concat(playerEl.name, "</span>\n      <span class=\"leaderboard__player__score\">").concat(playerEl.score, "</span>\n      </li>\n    ");
  });
  domElements.leaderboardList.innerHTML = html; // Render all the orbs from the orbArr

  globalObj.orbArr.forEach(function (orb) {
...
var mouseListner = function mouseListner(globalObj, domElements, canvasObj) {
  canvasObj.canvas.addEventListener("mousemove", function (event) {
    console.log("mouse is moved"); // The mosue position is given by client coordinates, not window coordinates
    ...
    var angleDeg = Math.atan2(mousePosition.y - canvasObj.canvas.height / 2, mousePosition.x - canvasObj.canvas.width / 2) * 180 / Math.PI; // Checking the postion and the distance of the mouse wrt center of the canvasObj.canvas
...
exports.mouseListner = mouseListner;
},{}],"socketStuff.js":[function(require,module,exports) {
"use strict";
...
var canvasStuff = _interopRequireWildcard(require("./canvasStuff.js"));
...
var init = function init(globalObj, domElements, canvasObj) {
  ...
  clientSocket.on("generalMessage", function (msg) {
    domElements.messageSpan.style.opacity = 1;
    domElements.messageSpan.textContent = msg;
    setTimeout(function () {
      domElements.messageSpan.style.opacity = 0;
...
exports.init = init;
},{"socket.io-client":"../../node_modules/socket.io-client/build/index.js","./canvasStuff.js":"canvasStuff.js"}],"UIStuff.js":[function(require,module,exports) {
"use strict";

var socketStuff = _interopRequireWildcard(require("./socketStuff.js"));
...
console.log("uistuff loaded"); // IMPORTED FILES

// import * as canvasClient from "./canvasStuff.js";
// GLOBALS TO THIS MODULE
var windowHeight = window.innerHeight;
var windowWidth = window.innerWidth;
var globalObj = {}; // Contains the positions of all the orbs on the canvas

globalObj.orbArr = []; // This obj contains the info of this particular currPlayer only

globalObj.currPlayer = {}; // Contains the details of the players in the game

globalObj.allPlayers = []; // Contains the sorted list of the players witht their scores

globalObj.leaderboard = []; ////////////////////////////////////////////////////////////////////////////////////
// DOM elements

var domElements = {}; // domElements.initModal = document.getElementById("modal__init");
// domElements.playerName = document.getElementById("modal__name");

domElements.container = document.querySelector(".container");
domElements.leaderboardWrapper = document.querySelector(".leaderboard__wrapper");
...
var initiateCanvas = function initiateCanvas() {
  // Instantiate the canvas element
  canvasObj.canvas = domElements.canvas; // console.log(canvasObj.canvas);
  // The context object contains all the properties, so that we can draw on the canvas

  canvasObj.context = canvasObj.canvas.getContext("2d"); // Change the size of the canvas to fit the window
...
window.addEventListener("load", function (event) {
  ...
  initiateCanvas(); // When the player finally starts the game, it calls the init fuction

  socketStuff.init(globalObj, domElements, canvasObj);
});
},{"./socketStuff.js":"socketStuff.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","UIStuff.js"], null)
//# sourceMappingURL=/UIStuffBundle.js.map